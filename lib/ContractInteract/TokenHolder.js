...
class TokenHolder {
  ...
  /**
   * It is used to get call prefix of executeRedemption method in TokenHolder contract.
   *
   * @returns {string} Encoded signature of executeRedemption method.
   */
  getTokenHolderExecuteRedemptionCallPrefix() {
    const executeRedemptionHash = this.auxiliaryWeb3.utils.soliditySha3(
  ...
  /**
   * It is used to initiate redemption through TokenHolder.
   *
   * @param {string} to The target contract address the transaction will be executed upon.
   * @param {string} data The payload of a function to be executed in the target contract.
   * @param {string} nonce The nonce of an session key that was used to sign the transaction.
  ...
  /**
   * Private method which returns executeRedemptionRawTx object .
   *
   * @param {string} to The target contract address the transaction will be executed upon.
   * @param {string} data The payload of a function to be executed in the target contract.
   * @param {string} nonce The nonce of an session key that was used to sign the transaction.
